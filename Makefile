...
all:
	$(ZIG) build kernel.zig --export exe --name clashos --target-os freestanding --target-arch armv7 --target-environ gnueabihf --linker-script linker.ld --ld-path $(LD) --ar-path $(AR) --release
